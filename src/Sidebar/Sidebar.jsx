...
export default function Sidebar({setIsDashboardUser, setIsDashboard}) {
  ...
  return (
    <div className="h-full   w-72 bg-black flex flex-col items-center justify-items-center align-middle">
      <ul className="flex w-full flex-col items-center align-middle justify-center">
        <li onClick={handleDashboard} className="w-full  cursor-pointer text-center hover:bg-gray-800 items-center align-middle justify-center flex text-white h-12 border-b border-gray-500 bg-black opacity-80">
        ...
        <li onClick={handleDashboardUser} className="w-full cursor-pointer text-center hover:bg-gray-800 items-center align-middle justify-center flex text-white h-12 border-b border-gray-500 bg-black opacity-50">
          <div className="w-1/3 flex items-center align-middle justify-center">
            <img className="w-9 mx-2" src="./src/img/account_circle.png" alt="" />
          </div>
          <p className="w-2/4">USERS</p>
        </li>
        <li className="w-full cursor-pointer text-center hover:bg-gray-800 items-center align-middle justify-center flex text-white h-12 border-b border-gray-500 bg-black opacity-50">
          <div className="w-1/3 flex items-center align-middle justify-center">
